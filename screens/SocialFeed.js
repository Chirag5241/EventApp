...
const SocialFeed = ({ navigation, route, params }) => {
  const imageUri =
    "https://img.buzzfeed.com/buzzfeed-static/static/2022-04/12/19/asset/b96d474ef097/sub-buzz-418-1649792177-24.png"; //+ "=s"+ (SIZES.width).toString()+ "-c"
  return (
            ...
            <View>
              <View style={styles.userBar}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  ...
                  <McText style={{ color: "#fff", marginLeft: 30 }} h3>
                    Bob with Alice
                  </McText>
                </View>
              ...
              <View style={styles.functionalBar}>
                <View style={styles.funcBarText}>
                  <McText style={{ color: "#fff" }} h3>
                    Event
                  </McText>
                  <McText style={{ color: "#fff" }} body3>
                    Location
                  </McText>
                </View>
                <View
